...
import { Users, Heart, Zap, Sparkles, CalendarDays, ArrowRight } from "lucide-react";
import logo from "../../assets/images/CASAN.LOGO.jpg";
    ...
    <div className="bg-gray-50">
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            ...
            <AnimatedSection animation="animate-on-scroll-left">
              <div className="space-y-6">
                <h1 className="text-5xl md:text-6xl font-bold leading-tight">
                  Altar Servers Association Of Nigeria
                </h1>
            ...
            <AnimatedSection animation="animate-on-scroll-right" className="hidden md:flex justify-center">
              <img
                src={logo}
                alt="CASAN LOGO"
                className="w-64 h-64 drop-shadow-2xl hover:border-4 border-green-300 rounded-full transition-all duration-300"
              />
            </AnimatedSection>
          </div>
        </div>
      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8 bg-gray-50 ">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6 transform-gpu">
            {[
              "Bali",
              "Kofai",
              "Jalingo",
        ...
        <footer className="bg-green-950 text-gray-600 py-12 px-4 sm:px-6 lg:px-8">
          <div className="max-w-6xl mx-auto">
            <div className="grid md:grid-cols-3 gap-8 mb-8">
              <div>
                <h4 className="text-white font-bold mb-4">About CASAN</h4>
                <p className="text-sm leading-relaxed">
                  Altar Servers Association of Nigeria - Jalingo Diocese
                </p>
              </div>
              <div>
            ...
            <div className="border-t border-white  pt-8 text-center text-sm">
              <p>&copy; 2026 CASAN Jalingo Diocese. All rights reserved.</p>
            </div>
          </div>
        </footer>
      </AnimatedSection>
